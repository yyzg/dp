...
// ============================= js -> lua logger 封装 =============================
// 约定: 通过dp2_lua_call把日志发回lua落盘 (df.logger)
function dp2_logger(level, msg) {
	try {
		...
		// arg1/arg2在这里不参与语义, 传0即可
		return dp2_lua_call(0, 0.0, payload);
	} catch (e) {
		// 兜底仍然输出到frida stdout
		console.log('[' + get_timestamp() + '] [frida] [warn] dp2_logger failed: ' + e);
		return 0;
	}
}

var logger = {
	debug: function (msg) { return dp2_logger('debug', msg); },
	info: function (msg) { return dp2_logger('info', msg); },
	warn: function (msg) { return dp2_logger('warn', msg); },
	error: function (msg) { return dp2_logger('error', msg); },
};
